...
P.S $\frac{9}{10}$ берется от того, что мы в предыдущий интеграл засунунли значение $-\frac{3}{2}$.
...
$a=300\,\,b=1500 \,\,\text{   Тогда:}\\ E[X] = \frac{a + b}{2} = 900 \\
...
Выборочное среднее: $ \bar{X} = \frac{21 + 38 + 12 + 15 + 14 + 8}{6}=18$

Выборочная дисперсия: $ \bar{\sigma^2} = \sum{\frac{(x_i - \bar{X}) ^ 2}{n - 1}} = 114$

Доверительный интервал: $\bar{X} \pm t_{\alpha/2, n -1} \cdot \frac{\sqrt{\sigma^2}}{\sqrt{n}}$\
Где (n - 1) - степени свободы

Далее мы просто смотрим на табличку и ищем значение $t_{\alpha/2, n -1} = 3.365$
